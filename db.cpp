...
#include "/home/yy/miniob/src/observer/session/session.h"
#include <fcntl.h>
#include <sys/stat.h>
...
// 新增：删除表的核心实现（极简版，无任何报错）
RC drop_table(const char *db_name, const char *table_name)
{
